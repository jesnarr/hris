...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <style type="text/css">
      ...
      /* END iOS BLUE LINKS */
      img {color: #ffffff;text-align: center;font-family: Helvetica, Arial, sans-serif;display: block;}
      body {margin: 0;padding: 0;-webkit-text-size-adjust: 100% !important;-ms-text-size-adjust: 100% !important;font-family: Helvetica, Arial, sans-serif!important;}
  ...
  <body style="margin:0; padding:0; background-color: #eeeeee;" bgcolor="#eeeeee">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#eeeeee">
      ...
      <tr>
        <td width="100%" valign="top" align="center" class="padding-container" style="padding: 8px 0px 8px 0px!important; mso-padding-alt: 8px 0px 8px 0px;">
                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container" align="center">
                              <tr>
                                <td align="center" class="hund" width="600">
                                  <img src="{{asset('img/admin-logo.png')}}" alt="LOGO" border="0" style="display:block; ">
                                </td>
                              </tr>
                            </table>
                          </td>
                        ...
                        <tr>
                          <td align="center">
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                              <tr>
                                <td class="td-padding" align="left" style="font-family: Helvetica, Arial, sans-serif; color: #212121!important; font-size: 24px; line-height: 30px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 13px;">
                                  Hi,
                                </td>
                              </tr>
                              <tr>
                                <td class="td-padding" align="left" style="font-family: Arial, Helvetica, sans-serif; color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 18px;">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td align="left" style="font-family: Arial, Helvetica, sans-serif; color: #212121!important; font-size: 14px;">
                                            This is to inform you that <strong>{{ $name }}</strong> has requested a leave from
                                                {{ $leave_type == 1 ? date('F d, Y g:i',strtotime($from)) : date('F d, Y g:i',strtotime($from)) }}
                                               to
                                               {{ $leave_type == 1 ? date('F d, Y',strtotime($to)) : date('F d, Y',strtotime($to)) }}
                                             </td>
                              ...
                              <tr>
                                <td align="left" style="padding: 10px 10px 10px 10px; mso-alt-padding: 10px 10px 10px 10px!important;">
                                </td>
                              </tr>
                            </table>
                          </td>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="wrapper" bgcolor="#eeeeee">
                  <tr>
                    <td align="center">
                      <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                        <tr>
                          <td class="td-padding" align="center" style="font-family: Helvetica, Arial, sans-serif; color: #212121!important; font-size: 12px; line-height: 24px; padding-top: 0px; padding-left: 0px!important; padding-right: 0px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 0px 0px 0px 0px;">
                            &copy; Jesnar Erpe
                          </td>
                        </tr>
                      </table>
